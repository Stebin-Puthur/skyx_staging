...
<div class="skytwo-banner d-flex justify-content-center align-items-center" >
  ...
  <video id="homepageVideo" autoplay loop muted playsinline poster="<?php echo get_stylesheet_directory_uri(); ?>/img/video/skytwo-video-poster.jpg">
    <source src="<?php echo get_stylesheet_directory_uri(); ?>/img/video/skytwo-drone-video2.webm" type="video/webm">
     <source src="<?php echo get_stylesheet_directory_uri(); ?>/img/video/skytwo-drone-video2.mp4" type="video/mp4">
  </video>
</div>
...
<div id="content" class="site-content">
	...
	<div id="primary" class="content-area">
      ...
      <?php get_template_part( 'template-parts/content-ctaskytwo' ); ?>
