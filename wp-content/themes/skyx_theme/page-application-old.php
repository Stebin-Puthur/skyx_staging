        ...
        <div class="container">
          ...
          <div class="row mb-5">
            ...
            ?>
              ...
              <div class="col-md-10 d-flex align-items-start align-items-lg-center flex-column flex-lg-row">
	          	<img class="img-fluid rounded-circle mr-4 mb-4 d-none d-md-block" src="<?php echo $process_image['url']; ?>" alt="<?php echo $process_image['alt']; ?>">
